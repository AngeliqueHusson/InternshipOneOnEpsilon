...
with open("Data/VideoID.txt", "rb") as fp:   # Unpickling
    ID_list = pickle.load(fp)
    
json_save_path = 'C:/Users/s157165/Documents/Jaar 5 2019-2020 Master/Internship Australia/InternshipOneOnEpsilon/Data/video_info'  ##set your own path

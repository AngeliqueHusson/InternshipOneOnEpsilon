...
NUN_CLASS = len(trainingBig.y_trainBig.unique())

train_dataset = pd.read_csv("trainingbig.csv", iterator=True)
training = pd.read_csv("training.csv", iterator=True)
validation = pd.read_csv("validation.csv", iterator=True)
...
VOCAB_SIZE = x_train_tfidf1.shape[1]
EMBED_DIM = 32
